                        ...
                        <nav className="flex items-center justify-end gap-4">
                            {auth.user ? (
                                ...
                                <button
                                    ...
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-white bg-red-500 hover:bg-red-600 dark:hover:bg-red-700"
                                >
                                    Login with Google
                                </button>
                            )}
